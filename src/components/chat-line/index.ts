...
let chatlinePersons = [
  {
    photoPerson: new Avatar("div", {photoPerson:"https://cdn.pixabay.com/photo/2016/11/18/19/07/happy-1836445_960_720.jpg"}),
    name: "Daniil ",
    lastMessage:
  ...
  {
    photoPerson: new Avatar("div", {photoPerson:"https://cdn.pixabay.com/photo/2018/01/21/14/16/woman-3096664_960_720.jpg"}),
    name: "Kino",
    lastMessage:
...
let chatLineComp = new ChatLines("div", { chatlinePersons })
export { chatLineComp }