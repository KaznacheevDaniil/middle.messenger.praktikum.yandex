...
let profileInfoPrepared = { avatar: { placeholder:'', type: 'text', name: 'Avatar', disabled: undefined, required: undefined},
                    email: { placeholder:'', type: 'email', name: 'Email', disabled: undefined, required: undefined},
                    login: { placeholder:'', type: 'text', name: 'Login', disabled: undefined, required: undefined},
                    first_name: { placeholder:'', type: 'text', name: 'Name', disabled: undefined, required: undefined},
                    second_name: { placeholder:'', type: 'text', name: 'Surname', disabled: undefined, required: undefined},
                    display_name: { placeholder:'', type: 'text', name: 'Nickname', disabled: undefined, required: undefined},
                    phone: { placeholder:'', type: 'tel', name: 'Phone', disabled: undefined, required: undefined} }
...
export default tmpl({
    form: formComp( '/edit', 'Edit profile', profileFieldsComp(fieldsWithoutAvatar(profileInfoPrepared)), buttonComp('save', 'save', 'submit')),
